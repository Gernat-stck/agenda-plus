        ...
        <div className="h-screen flex">
            <div className="flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 justify-around items-center">
                <div>
                    ...
                    <p className="text-white mt-1">Streamline your appointment management</p>
            ...
            <div className="flex w-1/2 justify-center items-center bg-white">
                <form className="bg-white">
                    ...
                    <p className="text-sm font-normal text-gray-600 mb-7">Please sign in to your account</p>
                    ...
                    <div className="flex justify-between mt-4">
                        <span className="text-sm text-gray-600 hover:text-blue-500 cursor-pointer">Forgot Password?</span>
                        <Link href="/register" className="text-sm text-gray-600 hover:text-blue-500 cursor-pointer">
                            Create an account
                        </Link>
                    </div>
                </form>
